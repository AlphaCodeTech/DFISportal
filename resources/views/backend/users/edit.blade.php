                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bank" class="form-control" id="bank">
                                            ...
                                            <option value="Access Bank Plc"
                                                {{ $user->bank == 'Access Bank Plc' ? 'selected' : '' }}>Access Bank Plc
                                            </option>
                                            <option value="Citibank Nigeria Limited"
                                                {{ $user->bank == 'Citibank Nigeria Limited' ? 'selected' : '' }}>Citibank
                                                Nigeria Limited</option>
                                            <option value="Diamond Bank Plc"
                                                {{ $user->bank == 'Diamond Bank Plc' ? 'selected' : '' }}>Diamond Bank Plc
                                            </option>
                                            <option value="Ecobank Nigeria Plc"
                                                {{ $user->bank == 'Ecobank Nigeria Plc' ? 'selected' : '' }}>Ecobank
                                                Nigeria Plc</option>
                                            <option value="Enterprise Bank"
                                                {{ $user->bank == 'Enterprise Bank' ? 'selected' : '' }}>Enterprise Bank
                                            </option>
                                            <option value="Fidelity Bank Plc"
                                                {{ $user->bank == 'Fidelity Bank Plc' ? 'selected' : '' }}>Fidelity Bank
                                                Plc</option>
                                            <option value="First Bank of Nigeria Plc"
                                                {{ $user->bank == 'First Bank of Nigeria Plc' ? 'selected' : '' }}>First
                                                Bank of Nigeria Plc</option>
                                            <option value="First City Monument Bank Plc"
                                                {{ $user->bank == 'First City Monument Bank Plc' ? 'selected' : '' }}>First
                                                City Monument Bank Plc</option>
                                            <option value="Guaranty Trust Bank Plc"
                                                {{ $user->bank == 'Guaranty Trust Bank Plc' ? 'selected' : '' }}>Guaranty
                                                Trust Bank Plc</option>
                                            <option value="Heritage Banking Company Ltd"
                                                {{ $user->bank == 'Heritage Banking Company Ltd' ? 'selected' : '' }}>
                                                Heritage Banking Company Ltd.</option>
                                            <option value="Key Stone Bank"
                                                {{ $user->bank == 'Key Stone Bank' ? 'selected' : '' }}>Key Stone Bank
                                            </option>
                                            <option value="MainStreet Bank"
                                                {{ $user->bank == 'MainStreet Bank' ? 'selected' : '' }}>MainStreet Bank
                                            </option>
                                            <option value="Skye Bank Plc"
                                                {{ $user->bank == 'Skye Bank Plc' ? 'selected' : '' }}>Skye Bank Plc
                                            </option>
                                            <option value="Stanbic IBTC Bank Ltd"
                                                {{ $user->bank == 'Stanbic IBTC Bank Ltd' ? 'selected' : '' }}>Stanbic IBTC
                                                Bank Ltd.</option>
                                            <option value="Standard Chartered Bank Nigeria Ltd"
                                                {{ $user->bank == 'Standard Chartered Bank Nigeria Ltd' ? 'selected' : '' }}>
                                                Standard Chartered Bank Nigeria Ltd.</option>
                                            <option value="Sterling Bank Plc"
                                                {{ $user->bank == 'Sterling Bank Plc' ? 'selected' : '' }}>Sterling Bank
                                                Plc</option>
                                            <option value="Union Bank of Nigeria Plc"
                                                {{ $user->bank == 'Union Bank of Nigeria Plc' ? 'selected' : '' }}>Union
                                                Bank of Nigeria Plc</option>
                                            <option value="United Bank For Africa Plc"
                                                {{ $user->bank == 'United Bank For Africa Plc' ? 'selected' : '' }}>United
                                                Bank For Africa Plc</option>
                                            <option value="Unity Bank Plc"
                                                {{ $user->bank == 'Unity Bank Plc' ? 'selected' : '' }}>Unity Bank Plc
                                            </option>
                                            <option value="Wema Bank Plc"
                                                {{ $user->bank == 'Wema Bank Plc' ? 'selected' : '' }}>Wema Bank Plc
                                            </option>
                                            <option value="Zenith Bank Plc"
                                                {{ $user->bank == 'Zenith Bank Plc' ? 'selected' : '' }}>Zenith Bank Plc
                                            </option>
                                        </select>
                                    </div>
                                    @error('bank')
                            ...
                            <div class="card-body">
                                    ...
                                    <select name="level_id" class="form-control" id="class_id">
                                        ...
                                        @foreach ($levels as $level)
                                            <option value="{{ $level->id }}"
                                                {{ $user->level_id == $level->id ? 'selected' : '' }}>{{ $level->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="religion" class="form-control" id="religion">
                                        ...
                                        <option value="christainity"
                                            {{ $user->religion == 'christainity' ? 'selected' : '' }}>Christainity</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="blood_group" class="form-control" id="blood_group">
                                        ...
                                        <option value="A+" {{ $user->blood_group == 'A+' ? 'selected' : '' }}>A+
                                        </option>
                                        <option value="A-" {{ $user->blood_group == 'A-' ? 'selected' : '' }}>A-
                                        </option>
                                        ...
                                        <option value="B+" {{ $user->blood_group == 'B+' ? 'selected' : '' }}>B+
                                        </option>
                                        <option value="B-" {{ $user->blood_group == 'B-' ? 'selected' : '' }}>B-
                                        </option>
                                        <option value="O+" {{ $user->blood_group == 'O+' ? 'selected' : '' }}>O+
                                        </option>
                                        <option value="O-" {{ $user->blood_group == 'O-' ? 'selected' : '' }}>O-
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="nationality" class="form-control" id="nationality">
                                        ...
                                        <option value="nigeria" {{ $user->nationality == 'nigeria' ? 'selected' : '' }}>
                                            Nigeria</option>
                                        <option value="other" {{ $user->nationality == 'other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                                </div>
                                @error('nationality')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="qualification" class="form-control" id="qualification">
                                        ...
                                        <option value="Bsc" {{ $user->qualification == 'Bsc' ? 'selected' : '' }}>Bsc
                                        </option>
                                        <option value="Msc" {{ $user->qualification == 'Msc' ? 'selected' : '' }}>Msc
                                        </option>
                                        <option value="HND" {{ $user->qualification == 'HND' ? 'selected' : '' }}>Hnd
                                        </option>
                                        <option value="OND" {{ $user->qualification == 'OND' ? 'selected' : '' }}>Ond
                                        </option>
                                        <option value="NCE" {{ $user->qualification == 'NCE' ? 'selected' : '' }}>Nce
                                        </option>
                                        <option value="BA" {{ $user->qualification == 'BA' ? 'selected' : '' }}>Ba
                                        </option>
                                        <option value="PGDE" {{ $user->qualification == 'PGDE' ? 'selected' : '' }}>Pgde
                                        </option>
                                        <option value="PROF" {{ $user->qualification == 'PROF' ? 'selected' : '' }}>Prof
                                        </option>
                                        <option value="DR" {{ $user->qualification == 'DR' ? 'selected' : '' }}>Dr
                                        </option>
                                        <option value="KCPE" {{ $user->qualification == 'KCPE' ? 'selected' : '' }}>Kcpe
                                        </option>
                                        <option value="KCSE" {{ $user->qualification == 'KCSE' ? 'selected' : '' }}>Kcse
                                        </option>
                                        <option value="UNDERGRADUATE"
                                            {{ $user->qualification == 'UNDERGRADUATE' ? 'selected' : '' }}>Undergraduate
                                        </option>
                                        <option value="ECDE" {{ $user->qualification == 'ECDE' ? 'selected' : '' }}>Ecde
                                        </option>
                                    </select>
                                </div>
                                @error('qualification')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2bs4 form-control" name="role[]" multiple="multiple"
