                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex; flex-direction:column">
                                                    @foreach ($parent->students as $std)
                                                        <a role="button" href="{{ route('student.show', $std->id) }}"
                                                            class="btn btn-sm btn-primary font-weight-bolder text-center">{{ $std->surname . ' ' . $std->middlename }}</a>
                                                    @endforeach
                                                </td>
                                                <td>{{ $parent->phone }}</td>
                                                ...
                                                <td class="d-flex" style="justify-content: space-evenly; padding-right: 0;">
                                                    <a title="edit" href="{{ route('parent.edit', $parent->id) }}"
                                                        role="button" class="btn btn-success"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a role="button" class="btn btn-warning" data-toggle="modal"
                                                        data-target="#modal-xl{{ $parent->id }}"><i class="fas fa-eye"
                                                            title="view parent"></i>
                                                        <div class="modal fade" id="modal-xl{{ $parent->id }}"
