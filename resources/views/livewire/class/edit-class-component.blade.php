                                ...
                                <div class="form-group">
                                    ...
                                    <select name="level_id" class="form-control" id="level_id">
                                       ...
                                       @foreach ($levels as $level)
                                           <option value="{{ $level->id }}" {{ $level->id == $class->level->id ? 'selected' : '' }}>{{ $level->name }}</option>
                                       @endforeach
                                    </select>
                                </div>
                                @error('level_id')
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" class="form-control" id="user_id">
                               ...
                               @foreach ($teachers as $teacher)
                                   <option value="{{ $teacher->id }}" {{ $teacher->id == $class->teacher->id ? 'selected' : '' }}>{{ $teacher->name }}</option>
                               @endforeach
                            </select>
                        </div>
                        @error('user_id')
