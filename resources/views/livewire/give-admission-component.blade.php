                                        ...
                                        @foreach ($students as $student)
                                            <tr>
                                                ...
                                                <td class="d-flex" style="justify-content: space-evenly; padding-right: 0;">
                                                    ...
                                                    <button wire:click.prevent='admit("{{ $student->id }}")'
                                                        title="Admit" role="button" class="btn btn-primary"><i
...
@push('extra-js')
    ...
    <script>
        ...
        window.addEventListener('admit', function(event) {
            swal({
                title: 'Success!',
                text: 'Student Successfully Admitted!',
                icon: 'success',
                button: "OK!",
            }).then(function(value) {
                if (value) {
...
{{-- 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 --}}