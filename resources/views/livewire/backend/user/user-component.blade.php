                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td class="d-flex"
                                                    ...
                                                    <a title="edit" wire:click="edit({{ $user }})"
                                                        role="button" class="btn btn-success"><i
                                                            class="fas fa-edit"></i></a>
                                                    <button wire:click="show({{ $user }})" role="button"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select wire:model.defer='state.role[]'
                                                ...
                                                name="role[]" multiple="multiple" data-placeholder="Select a Role"
                                                style="width: 100%;">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            <img src="{{ asset($selectedUser->photo ?? '') }}" alt="{{ $selectedUser->name ?? '' }}"
                                ...
                                <div class="card mb-3">
                                    <div class="card-body text-left">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{-- {{
                                                ucwords($selectedUser->level->name)
                                                }} --}}
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{-- {{
                                                ucwords($selectedUser->department->name
                                                . ' Staff') }} --}}
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{ ucwords($selectedUser->marital_status) }}
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{ ucwords($selectedUser->blood_group) }}
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{ ucwords($selectedUser->nationality) }}
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{ ucwords($selectedUser->qualification) }}
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{ ucwords($selectedUser->account_number) }}
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{ ucwords($selectedUser->account_name) }}
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
