                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($departments as $department)
                                            <tr>
                                                <td>{{ Str::headline($department->name) }}</td>

                                                <td class="d-flex"
                                                    style="justify-content: space-evenly; padding-right: 0;">
                                                    @can('edit department')
                                                        <a title="edit" wire:click="edit({{ $department }})"
                                                            role="button" class="btn btn-success"><i
                                                                class="fas fa-edit"></i></a>
                                                    @endcan
                                                    <button wire:click="show({{ $department }})" role="button"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            ...
                                            <div class="mt-3">
                                                <h4>{{ Str::headline(optional($selectedDepartment)->name) ?? '' }}
                                                </h4>
                                    ...
                                    <div class="card-body text-left">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                {{ ucwords(optional($selectedDepartment)->name) ?? '' }}
                                            </div>
                                        </div>
                                        <hr>
