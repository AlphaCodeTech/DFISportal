                        ...
                        <div class="card">
                            <div class="card-header">
                                <ul class="nav nav-tabs nav-tabs-highlight">
                                    <li class="nav-item"> <a wire:click='allGraduatedStudent' class="nav-link active"
                                            data-toggle="tab">All Graduated Students</a></li>
                                    <li class="nav-item dropdown" style="width: 150px;">
                                        <a href="#" class="nav-link dropdown-toggle"
                                            data-toggle="dropdown">Select Class</a>
                                    ...
                                    <tbody>
                                        @foreach ($students as $student)
                                            <tr>
                                                ...
                                                <td class="text-center"><img class="rounded-circle img-thumbnail img-responsive"
                                                        src="{{ asset($student->photo) }}" alt="{{ $student->name }}"
                                                        style="width: 100px; height: 100px;"></td>
                                                <td class="text-center">
                                                    <livewire:backend.graduated-button :model="$student" field="graduated"
                                                        key="{{ $student->id }}">
                                                </td>
                                                <td class="d-flex"
