                    ...
                    @if (!$selected)
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <!-- form start -->
                                <form wire:submit.prevent='tabulation_select'>
                                    <div class="card-body">
                                        <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer text-right">
                                        <a target="_blank" href="{{ route('marks.print_tabulation', [$exam_id, $class_id, $section_id]) }}" class="btn btn-danger">
