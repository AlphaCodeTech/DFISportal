                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select wire:model.defer='state.current_session'
                                            ...
                                            id="current_session">
                                            <option value=""></option>
                                            @foreach (App\Models\Session::all() as $y)
                                                <option value="{{ $y->name }}"
                                                    {{ $state['current_session'] == $y->name ? 'selected' : '' }}>
                                                    {{ $y->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div data-date="12-02-2012" data-date-format="dd-mm-yyyy"
                                            ...
                                            <input wire:model.defer='state.term_begins' id="term_begins" type="text"
                                    ...
                                    <div class="form-group">
                                        <label for="term_ends">Next Term Ends</label>
                                        <div data-date="12-02-2012" data-date-format="dd-mm-yyyy"
                                            class="input-group date">
                                            <input wire:model.defer='state.term_ends' id="term_ends" type="text"
